...
def makePositronImages(simFile, Munit, positronRatios=np.linspace(0,1,2), nameBase='../ipole_output/positron_test/positron_test.h5', inclination=163.0, Rhigh=20, freq_Hz=228e9, \
    ipole='/work/vmo703/aricarte/run_ipole.sh',fov=160.0, npixel=320, counterjet=0, rmax_geo=50):
...
#'/n/home13/anantua/ipole/aricarte/ipole+e-/ipole'
    ...
    for positronRatio in positronRatios:
        MunitOffset = 2.5e+28 #MADpt94:5e24,5e24,5e24,3.5e24 #MAD-pt5:1.4e25,9.e24,1.5e25,8.5e24 #SANE-pt5:2.6e28,8.e27,2e28,7.5e27 #Sim:R-Beta,RBetaBetaE,BetaC,BetaCBetaE  #1.2e+28 r50 1e28SaCrBetHyb  
        MunitSlope = 2.5e+1  #MADpt94:.2e1,.15e1,1.5e0,1.5e0 #MAD-pt5:.5e1,4.5e0,3.5e0,4.e0 #SANE-pt5:2.5e1,2e1,2.5e1,2.e1 #Sim:R-Beta,RBetaBetaE,BetaC,BetaCBetaE  #1.0e1  r50 1Pt5e1SaCrBetHyb
...
#    makePositronImages(simFile, Munit, positronRatios, Rhigh=Rhigh, nameBase=nameBase)
    ...
    simFile = '/work/vmo703/grmhd_dump_samples/Sa-0.5_5000.h5'
    ...
    Munit = 1.82523e+27
    Rhigh = 20
    nameBase = '/work/vmo703/ipole_outputs/positron_test_Sa-0.5_5000.h5'
